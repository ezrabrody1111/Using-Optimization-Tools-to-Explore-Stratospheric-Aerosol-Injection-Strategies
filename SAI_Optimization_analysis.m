...
ControlLog_EQ_001 = readmatrix(strcat('ControlLog_0N_1.0.001.txt'));
ControlLog_EQ_002 = readmatrix(strcat('ControlLog_0N_1.0.002.txt'));
ControlLog_EQ_003 = readmatrix(strcat('ControlLog_0N_1.0.003.txt'));
ControlLog_15N_15S_001 = readmatrix(strcat('ControlLog_15N_15S.001.txt'));
ControlLog_15N_15S_002 = readmatrix(strcat('ControlLog_15N_15S.002.txt'));
ControlLog_15N_15S_003 = readmatrix(strcat('ControlLog_15N_15S.003.txt'));
ControlLog_30N_30S_001 = readmatrix(strcat('ControlLog_30N_30S.001.txt'));
ControlLog_30N_30S_002 = readmatrix(strcat('ControlLog_30N_30S.002.txt'));
ControlLog_30N_30S_003 = readmatrix(strcat('ControlLog_30N_30S.003.txt'));
ControlLog_60N_60S_001 = readmatrix(strcat('ControlLog_60N_60S_1.0.001.txt'));
ControlLog_60N_60S_002 = readmatrix(strcat('ControlLog_60N_60S_1.0.002.txt'));
ControlLog_60N_60S_003 = readmatrix(strcat('ControlLog_60N_60S_1.0.003.txt'));
